...
namespace DovahAI_Space{
    ...
    void DovahAI::TalonSmash1(RE::Actor *a_actor)
    {
        ...
        GFunc_Space::GFunc::Call_Papyrus_Function(a_actor, "dragonActorSCRIPT", "LDP_PlayImpactEffect", RE::MakeFunctionArguments(skyrim_cast<RE::BGSImpactDataSet *>(FXDragonLandingImpactSet), empty_str));
