...
namespace DovahAI_Space{
    ...
    void DovahAI::TalonSmash1(RE::Actor *a_actor)
    {
        ...
        GFunc_Space::GFunc::Call_Papyrus_Function(a_actor, "dragonActorSCRIPT", "LDP_PlayImpactEffect", RE::MakeFunctionArguments(std::bit_cast<RE::BGSImpactDataSet *>(FXDragonLandingImpactSet), std::bit_cast<const char *>(empty_str)));
    ...
    void DovahAI::SetValuesDragon(RE::Actor *a_actor)
    {
        ...
        a_actor->AsActorValueOwner()->SetActorValue(RE::ActorValue::kDamageResist, static_cast<float>((LvRank * 45.0) / (1.0 + abs(3.0 - log(RE::PlayerCharacter::GetSingleton()->GetLevel())) * pow(2.718, (-1.0 * LvRank)))));
    ...
    {
        const auto caster = a_actor->GetMagicCaster(RE::MagicSystem::CastingSource::kInstant);
        caster->CastSpellImmediate(RE::TESForm::LookupByEditorID<RE::MagicItem>("LDP_aaaUDMagicAttackSpell"), true, a_actor, 1, false, 0.0, a_actor);
    }
